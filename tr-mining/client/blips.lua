...
if Config.UseBlips then
    CreateThread(function()
        MDBlip = AddBlipForCoord(MinerDepo.coords)
        SetBlipSprite (MDBlip, MinerDepo.SetBlipSprite)
        SetBlipDisplay(MDBlip, MinerDepo.SetBlipDisplay)
        SetBlipScale  (MDBlip, MinerDepo.SetBlipScale)
        SetBlipAsShortRange(MDBlip, true)
        SetBlipColour(MDBlip, MinerDepo.SetBlipColour)
        BeginTextCommandSetBlipName("STRING")
        AddTextComponentSubstringPlayerName(MinerDepo.BlipLabel)
